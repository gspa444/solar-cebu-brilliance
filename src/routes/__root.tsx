...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Green Sun" },
      { name: "description", content: "A premium landing page for Green Sun Power Systems, offering solar solutions for Cebu residents and businesses." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Green Sun" },
      { property: "og:description", content: "A premium landing page for Green Sun Power Systems, offering solar solutions for Cebu residents and businesses." },
